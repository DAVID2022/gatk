...
public class ReadsSparkSourceUnitTest extends GATKBaseTest {
    ...
    private void doLoadReads(String bam, String referencePathName, ValidationStringency validationStringency) {
        ...
        final GATKInputPath referenceInputPath = referencePathName == null ? null : new GATKInputPath(referencePathName);
    ...
    public void shardedReadsSparkSourceTest(String expectedBam, String shardedBam, String referencePath) {
        JavaSparkContext ctx = SparkContextFactory.getTestSparkContext();
        final GATKInputPath referenceInputPath = referencePath == null ? null : new GATKInputPath(referencePath);
    ...
    public void testCRAMReferenceFromHDFS() throws Exception {
        ...
        final GATKInputPath reference = new GATKInputPath(v37_chr17_1Mb_Reference);
        final GATKInputPath referenceIndex = new GATKInputPath(v37_chr17_1Mb_Reference + ".fai");
        ...
        MiniClusterUtils.runOnIsolatedMiniCluster( cluster -> {
            ...
            final List<GATKRead> hdfsReads = readsSparkSource.getParallelReads(cramHDFSPath.toUri().toString(), new GATKInputPath(refHDFSPath.toUri().toString())).collect();
     ...
     */
    public JavaRDD<GATKRead> getSerialReads(final JavaSparkContext ctx, final String bam, final GATKInputPath referencePath, final ValidationStringency validationStringency) {
